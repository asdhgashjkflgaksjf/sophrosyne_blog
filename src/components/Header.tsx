  ...
  return (
    <header className="sticky top-0 z-50 py-3 sm:py-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main header bar with paper style */}
        <div className="relative flex items-center justify-between h-14 sm:h-16 px-4 sm:px-6 bg-[hsl(var(--paper-cream))] border border-border rounded-2xl overflow-hidden paper-shadow">
          {/* Paper grain overlay */}
          <div
